...
import { CanceledPaymentServiceMonthly } from './canceled-payment-service-monthly';

describe('Canceled Payment Service Monthly use case', () => {
  it('should be able to canceled payment service monhtly', async () => {
    ...
    const canceledPaymentService = new CanceledPaymentServiceMonthly(
      paymentServiceMonthlyRepository,
    );
    ...
    const { paymentServiceMonthly } = await canceledPaymentService.execute(
