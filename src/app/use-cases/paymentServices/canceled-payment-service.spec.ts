...
import { CanceledPaymentService } from './canceled-payment-service';

describe('Canceled Payment Service use case', () => {
  it('should be able to canceled payment service', async () => {
    ...
    const canceledPaymentService = new CanceledPaymentService(
      paymentServiceRepository,
    );
    ...
    const { paymentService } = await canceledPaymentService.execute(
