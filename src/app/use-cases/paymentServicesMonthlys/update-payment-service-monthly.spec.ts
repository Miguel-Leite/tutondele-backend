...
import { UpdatePaymentServiceMonthly } from './update-payment-service-monthly';

describe('Update payment monthly use case', () => {
  it('should be able to update payment monthly', async () => {
    ...
    const updatePaymentServiceMonthly = new UpdatePaymentServiceMonthly(
      paymentServiceMonthlyRepository,
      serviceMonthlyRepository,
    );
    ...
    const { paymentServiceMonthly } = await updatePaymentServiceMonthly.execute(
      {
        id: created.paymentServiceMonthly.id,
        servicesMonthlysId: serviceMonthly.id,
        account_number: '4565906632',
        iban: '00060000058959393',
        studentsId: 'example-students-id',
