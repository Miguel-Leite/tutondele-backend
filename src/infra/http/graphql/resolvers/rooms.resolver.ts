...
export class RoomsResolver {
  ...
  @UseGuards(AuthGuard)
  @Mutation(() => RoomModel)
  async addRoom(@Args("data") data: CreateRoomInput, @CurrentCustomer() customer: IAuthCustomer) {
  ...
  @UseGuards(AuthGuard)
  @Mutation(() => RoomModel)
  async editRoom(@Args("data") data: UpdateRoomInput, @CurrentCustomer() customer: IAuthCustomer) {
