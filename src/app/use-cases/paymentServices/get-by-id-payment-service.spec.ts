...
import { GetByIdPaymentService } from './get-by-id-payment-service';

describe('Get By Id Payment Service use case', () => {
  it('should be able to get by id payment service', async () => {
    ...
    const getByIdPaymentService = new GetByIdPaymentService(
      paymentServiceRepository,
    );
    ...
    const { paymentService } = await getByIdPaymentService.execute(
