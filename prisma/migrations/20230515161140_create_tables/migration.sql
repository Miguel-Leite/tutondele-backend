...
-- CreateIndex
CREATE INDEX "organizations_packagesId_idx" ON "organizations"("packagesId");
...
-- AddForeignKey
ALTER TABLE "organizations" ADD CONSTRAINT "organizations_addressesId_fkey" FOREIGN KEY ("addressesId") REFERENCES "addresses"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "organizations" ADD CONSTRAINT "organizations_contactsId_fkey" FOREIGN KEY ("contactsId") REFERENCES "contacts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
