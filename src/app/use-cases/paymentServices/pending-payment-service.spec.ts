...
describe('Pending Payment Service use case', () => {
  it('should be able to pending payment service', async () => {
    ...
    const pendingPaymentService = new PendingPaymentService(
      paymentServiceRepository,
    );
    ...
    const { paymentService } = await pendingPaymentService.execute(
