...
describe('Deactivate organization use case', () => {
  it('should be able to deactivate organization', async () => {
    ...
    const deactivateOrganization = new DeactivateOrganization(organizationRepository);
    ...
    const { organization } = await deactivateOrganization.execute(response.organization.id);
  ...
  it('should not be able to deactivate organization', async () => {
    ...
    expect(
      async () => await deactivateOrganization.execute('example-organization-id')
